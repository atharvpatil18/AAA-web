        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-5 md:p-8">
          ...
          {hubTab === "sets" && (
            <div>
              ...
              <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border-2 border-amber-400/40 text-slate-900 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
                <div className="flex items-center space-x-3">
