  ...
  return (
    <div className="bg-slate-50 min-h-screen py-10 px-4 flex items-center justify-center relative overflow-hidden">
      ...
      <div className={`w-full ${authMode === "guest" ? "max-w-2xl" : "max-w-md"} bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden relative z-10 transition-all duration-300`}>
        ...
        {/* Out-of-the-Box Ultra-Compact Speed Math Banner */}
        <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 px-3.5 py-2.5 text-slate-950 border-b border-amber-300 relative overflow-hidden group shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 relative z-10">
            
            {/* Left: Flame Icon + Compact Title & Badges */}
            <div className="flex items-center gap-2">
              <div className="bg-slate-950 text-amber-400 p-1.5 rounded-lg shrink-0 shadow animate-pulse">
                <Flame className="w-4 h-4 fill-amber-400 text-amber-400" />
              </div>
              <div>
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span className="bg-slate-950 text-amber-400 text-[9px] font-black px-2 py-0.2 rounded-md uppercase tracking-wider shadow">
                    🔥 GUEST PRACTICE TRIAL
                  </span>
                  <span className="text-[9px] font-bold text-slate-900 bg-white/40 px-1.5 py-0.2 rounded backdrop-blur-xs">
                    NO OTP REQUIRED
                  </span>
                </div>
                <h3 className="text-xs font-black tracking-tight text-slate-950 leading-snug mt-0.5">
                  Test 10X Calculation Speed ({selectedQuestionCount} Qs Speed Drill)
                </h3>
              </div>
            </div>

            {/* Right: High-Energy Action Button Pointing Down */}
            <button
              type="button"
              onClick={() => {
                setAuthMode("guest");
              ...
              className="bg-slate-950 hover:bg-slate-900 text-amber-300 text-[10px] font-black px-3 py-1.5 rounded-xl flex items-center gap-1 shadow-lg hover:scale-105 active:scale-95 transition-all cursor-pointer border border-amber-400 shrink-0 group-hover:ring-2 group-hover:ring-amber-400/50"
            >
              <Zap className="w-3 h-3 fill-amber-400 text-amber-400" />
              <span>TRY FREE GUEST DRILL</span>
