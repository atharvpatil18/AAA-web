...
export default function Showcase({ defaultTab = "all" }: { defaultTab?: "all" | "stories" | "gallery" }) {
  ...
  const showcaseData: SuccessItem[] = [
    ...
    },
    {
      ...
      achievementText: "Bagged Gold Medal at the National Mental Arithmetic Competition (IIVA and SmartKid association), solving 100 sums in 5 minutes flat.",
      imageAlt: "Anaya Deshmukh holding award certificate",
      colorTheme: "gold",
      mainCategory: "national_state"
    },
    {
